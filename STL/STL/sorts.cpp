...
//  STL
//
//  Created by Jenna Wang on 5/27/23.
//
...
void sortUsingPtrs(vector<Store>& stores, bool comp(const Store*, const Store*))
{
    ...
    for(int i = 0; i < vecStores.size(); i++)
    {
        stores[i] = *vecStores[i];
    }
